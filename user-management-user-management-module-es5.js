...
var ListingUserComponent = /** @class */ (function () {
    ...
    ListingUserComponent.prototype.observe = function () {
        this.usserListingService.observeResponce().subscribe(function (res) {
            switch (res.type) {
                ...
                case _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpEventType"].DownloadProgress:
                    var loaded = Math.round(res.loaded / 1025);
                    var total = Math.round(res.total / 1025);
    ...
    ListingUserComponent.prototype.onClick = function (evt) {
        this.observe();
    };
...
var UserListingService = /** @class */ (function () {
    ...
    UserListingService.prototype.handleError = function (error) {
        debugger;
    ...
    // }
    UserListingService.prototype.observeResponce = function () {
        var id = "1";
        var name = "yash";
        ...
        debugger;
        return this.http.get("src/assets/data/abc.json", { observe: "events", responseType: "json", reportProgress: true, params: params, headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
    };
