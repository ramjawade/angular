...
const routes = [{
        ...
        path: 'map',
        loadChildren: () => __webpack_require__.e(/*! import() | g-map-g-map-module */ "g-map-g-map-module").then(__webpack_require__.bind(null, /*! ./g-map/g-map.module */ "./src/app/g-map/g-map.module.ts")).then(m => m.GMapModule)
    }, {
        path: 'projects',
        ...
        path: "user",
        loadChildren: () => __webpack_require__.e(/*! import() | user-management-user-management-module */ "user-management-user-management-module").then(__webpack_require__.bind(null, /*! ./user-management/user-management.module */ "./src/app/user-management/user-management.module.ts")).then(m => m.UserManagementModule)
    }, {
        path: '**',
