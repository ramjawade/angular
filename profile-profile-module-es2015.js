...
let GlobleCommonService = class GlobleCommonService {
    constructor(http) {
        this.http = http;
    }
    sendGetRequest(url, oprtion) {
...
GlobleCommonService.ctorParameters = () => [
...
let TimelineLayoutComponent = class TimelineLayoutComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let TringleComponent = class TringleComponent {
    constructor() { }
    ngOnInit() {
        if (this.type === 'up') {
            this.lScreen = "down";
